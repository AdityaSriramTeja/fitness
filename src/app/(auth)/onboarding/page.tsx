...
const page = () => {
  return (
    <div className='border-2 h-full w-[70%] flex flex-col p-5 rounded-lg gap-y-10'>
        <h1> Onboarding</h1>
        <span className='flex items-center gap-x-5'> <h5> First Name: </h5> <input type="text" className='input' /></span>
        <span className='flex items-center gap-x-5'> <h5> Last Name: </h5> <input type="text" className='input' /></span>
        <span className='flex items-center gap-x-5'> <h5> Phone Number: </h5> <input type="text" className='input' /></span>
        <span className='flex items-center gap-x-5'> <h5> Primary Address: </h5> <input type="text" className='input' /></span>
        <span className='flex items-center gap-x-5'> <h5> Email : </h5> <input type="text" className='input' /></span>
    ...
    <h4> Enter your starting weight and height (you can edit this later) </h4>
        <span className='flex items-center gap-x-5'> <h5> Weight : </h5> <input type="text" className='input' /></span>
        <span className='flex items-center gap-x-5'> <h5> Height : </h5> <input type="text" className='input' /></span>
