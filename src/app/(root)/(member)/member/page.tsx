    ...
    <div className='p-10 h-full space-y-10 '>
        ...
        <div className="border-2 rounded-xl p-5 space-y-10 ">
            ...
            <div className='grid grid-cols-2 h-full'> 
                <span className='text-lg font-semibold capitalize'>weight: 80</span>
                <span className='text-lg font-semibold capitalize'>average sleep: 80 </span>
                <span className='text-lg font-semibold capitalize'>average calories burnt: 80</span>
                <span className='text-lg font-semibold capitalize'>average calories intake: 80</span>
            </div>
        </div>
      <MemberAchievements/>
       <MemberRoutine/>
